...
function validateAddress(){
    ...
    if (tcity != undefined){
        if (tcity.toLowerCase() !== "berlin"){
            ...
            if (myForm.bzrnr != '') {
                var adr = callbzrinfo();
                myForm.bzrname = adr.bzrname;
                myForm.otname = adr.otname;
                res = true;
            }
        }else{
            res = false
...
function callbzrinfo(){
    var res;
    var strname = myForm.F00000053;
    var hnr = myForm.F00000016;
    var hnrz = myForm.F00000084;
    var plz = myForm.F00000054;
    var city = "berlin";
...
function rbsrule(){
    var res = true;
    if (myForm.rbs_valid != undefined && myForm.F00000035 != undefined){
